...
public class CustomOAuth2SuccessHandler implements AuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws IOException, ServletException {
        ...
        GitHubUser user = new GitHubUser()
            ...
            .setAvatar(new Image().setUrl(avatarUrl))
            .setAccessToken(new GitHubAuthentication(accessToken, accessTokenExpiresAt.toEpochMilli()))
            .setRefreshToken(refreshToken != null ? new GitHubAuthentication(refreshToken, refreshTokenExpiresAt.toEpochMilli()) : null);
